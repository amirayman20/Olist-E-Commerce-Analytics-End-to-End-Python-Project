...
* **📁 المسار:** `![Order Status](./images/order_status_bar_chart.png)`
...
* **📁 المسار:** `![Monthly Trend](./images/monthly_orders_line_chart.png)`
...
* **📁 المسار:** `![Daily Pattern](./images/daily_pattern_line_chart.png)`
...
* **📁 المسار:** `![Weekly Pattern](./images/weekly_pattern.png)`
...
* **📁 المسار:** `![Hourly Orders](./images/hourly_orders.png)`
...
* **📁 المسار:** `![Payment Type](./images/payment_type_pie.png)`
...
* **📁 المسار:** `![Installments](./images/installments_distribution.png)`
...
* **📁 المسار:** `![Order Value](./images/order_value_histogram.png)`
...
* **📁 المسار:** `![Freight Value](./images/freight_value_distribution.png)`
...
* **📁 المسار:** `![Price vs Freight](./images/price_vs_freight.png)`
...
* **📁 المسار:** `![Volume vs Freight](./images/volume_vs_freight.png)`
...
* **📁 المسار:** `![Top Categories](./images/top_categories.png)`
...
* **📁 المسار:** `![Category Revenue](./images/category_revenue.png)`
...
* **📁 المسار:** `![Product Weight](./images/product_weight.png)`
...
* **📊 المخطط البياني:** `Bar Chart`
* **📁 المسار:** `![Top Cities](./images/top_cities.png)`
...
* **📁 المسار:** `![Customer Distribution](./images/customer_state_distribution.png)`
...
* **📁 المسار:** `![Seller Distribution](./images/seller_distribution.png)`
...
* **📁 المسار:** `![Delivery Time](./images/delivery_time.png)`
...
* **📁 المسار:** `![Delivery Delay](./images/delivery_delay.png)`
...
* **📁 المسار:** `![Delivery by State](./images/delivery_by_state.png)`
...
* **📁 المسار:** `![Review Score](./images/review_score_distribution.png)`
...
* **📁 المسار:** `![Review vs Delay](./images/review_vs_delay.png)`
...
* **📁 المسار:** `![Review Text Length](./images/review_text_length.png)`
