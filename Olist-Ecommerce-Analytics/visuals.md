...
---## 📌 1) Order & Time-Series Visualizations### 📊 1.1 Order Status Distribution* **📊 المخطط البياني:** `Bar Chart`* **📁 المعاينة المرئية:**
...
### 📈 1.2 Monthly Orders Trend* **📊 المخطط البياني:** `Time-Series Line Chart`* **📁 المعاينة المرئية:**
...
### 📉 1.3 Daily Demand Pattern* **📊 المخطط البياني:** `Cyclical Line Chart`* **📁 المعاينة المرئية:**
...
---## 📌 2) Financial & Price Visualizations### 💰 2.1 Distribution of Average Order Value (AOV)* **📊 المخطط البياني:** `Right-Skewed Histogram`* **📁 المعاينة المرئية:**
...
### 💵 2.2 Price Distribution Analysis* **📊 المخطط البياني:** `Price Distribution Plot`* **📁 المعاينة المرئية:**
...
### 📈 2.3 Price Range Distribution Percentages* **📊 المخطط البياني:** `Distribution Percentage Chart`* **📁 المعاينة المرئية:**
...
---## 📌 3) Freight & Logistics Metrics### 🚚 3.1 Freight Cost Variance* **📊 المخطط البياني:** `Density Plot`* **📁 المعاينة المرئية:**
...
### 📦 3.2 Product Volumetrics vs. Weight* **📊 المخطط البياني:** `Scatter Plot`* **📁 المعاينة المرئية:**
...
### 🚨 3.3 Actual vs. Estimated Delivery Comparison* **📊 المخطط البياني:** `Comparison Plot`* **📁 المعاينة المرئية:**
...
### ⏳ 3.4 Estimated Delivery Time Distribution* **📊 المخطط البياني:** `Estimated Time Histogram`* **📁 المعاينة المرئية:**
...
### ⏱️ 3.5 Delivery Delay Variance* **📊 المخطط البياني:** `Delay Histogram`* **📁 المعاينة المرئية:**
...
### 🏁 3.6 On-Time vs. Late Delivery Rate* **📊 المخطط البياني:** `Rate Comparison Chart`* **📁 المعاينة المرئية:**
...
---## 📌 4) Product & Category Intelligence### 🏆 4.1 Top Performing Product Categories* **📊 المخطط البياني:** `Horizontal Bar Chart`* **📁 المعاينة المرئية:**
...
### 🛒 4.2 Top Products by Orders & Quantity Sold* **📊 المخطط البياني:** `Volume Charts`* **📁 المعاينة المرئية:**
...
### 💵 4.3 Top Products by Revenue & Best Selling* **📊 المخطط البياني:** `Revenue Charts`* **📁 المعاينة المرئية:**
...
---## 📌 5) Geospatial & Operational Clustering### 🗺️ 5.1 Regional Customer Density Map* **📊 المخطط البياني:** `Geospatial Choropleth Map`* **📁 المعاينة المرئية:**
...
### 🏙️ 5.2 Top Customer Cities* **📊 المخطط البياني:** `Bar Chart`* **📁 المعاينة المرئية:**
...
### 📦 5.3 Single vs. Multi-Item Orders Analysis* **📊 المخطط البياني:** `Order Composition Chart`* **📁 المعاينة المرئية:**
...
---## 📌 6) Customer Sentiment & Experience### ⭐ 6.1 Review Score Frequency* **📊 المخطط البياني:** `Categorical Bar Chart`* **📁 المعاينة المرئية:**
...
### 📉 6.2 Customer Evaluation Average* **📊 المخطط البياني:** `Score Metrics`* **📁 المعاينة المرئية:**
...
### 🚨 6.3 Correlation: Shipping Delay vs. Review Score* **📊 المخطط البياني:** `Bivariate Heatmap`* **📁 المعاينة المرئية:**
