...
يحتوي هذا الملف على معرض الرسومات البيانية الكامل التي تم إنتاجها وحفظها تلقائياً أثناء مرحلة التحليل الاستكشافي (EDA). يمكنك الضغط على اسم أي مخطط بياني لمعاينته مباشرة بدقة عالية من داخل المستودع.
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة Bar Chart الخاص بحالة الطلبات](images/order_status_bar_chart.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة Line Chart الخاص بنمو الطلبات الشهري](images/monthly_orders_line_chart.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة Line Chart الخاص بنمط الطلب اليومي](images/daily_pattern_line_chart.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة Histogram الخاص بتوزيع قيم الطلبات](images/order_value_histogram.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة الرسم البياني لتوزيع أسعار المنتجات](images/price_distribution.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط النسب المئوية لنطاقات الأسعار](images/price_range_distribution_percent.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة Density Plot الخاص بتكاليف الشحن](images/freight_value_distribution.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط حجم المنتج مقابل الوزن](images/product_volume_vs_weight.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط مقارنة التوصيل الفعلي بالمتوقع](images/actual_vs_estimated_delivery_comparison.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة Histogram أوقات التوصيل المتوقعة](images/estimated_delivery_time_histogram.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة Histogram أيام تأخير الشحنات](images/delivery_delay_histogram.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط نسبة التوصيل في الموعد مقابل المتأخر](images/on_time_vs_late_delivery_rate.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط الفئات الأكثر مبيعاً](images/top_product_categories.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة المنتجات الأكثر طلباً](images/top_products_by_orders.png) | 🔗 [وهنا لمعاينة المنتجات الأكثر مبيعاً ككمية](images/top_products_by_quantity_sold.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة المنتجات الأعلى تحقيقاً للإيرادات](images/top_products_by_revenue.png) | 🔗 [وهنا لمعاينة المنتجات الأكثر مبيعاً وتداولاً](images/top_selling_products.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة خريطة التوزيع الجغرافي للعملاء](images/customer_distribution_map.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط المدن الأكثر طلباً](images/top_customer_cities.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط الطلبات الفردية مقابل المتعددة](images/single_vs_multi_item_orders.png)
...
* **📊 المخطط البياني:** `Categorical Bar Chart` -> 🔗 [اضغط هنا لمعاينة مخطط توزيع التقييمات](images/Review_score_distribution.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط متوسط التقييم العام](images/average_review_score.png)
...
* **📊 المخطط البياني:** 🔗 [اضغط هنا لمعاينة مخطط علاقة تأخير الشحن بانخفاض التقييم](images/delivery_delay_vs_review_score.png)
